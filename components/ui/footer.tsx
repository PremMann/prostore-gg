      ...
      <div className="wrapper py-12 md:py-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-6">
              <div className="w-10 h-6 rounded bg-white/10 flex items-center justify-center">
                <span className="text-[10px] text-zinc-400 font-medium">VISA</span>
              </div>
              <div className="w-10 h-6 rounded bg-white/10 flex items-center justify-center">
                <span className="text-[10px] text-zinc-400 font-medium">MC</span>
              </div>
              <div className="w-10 h-6 rounded bg-white/10 flex items-center justify-center">
                <span className="text-[10px] text-zinc-400 font-medium">AMEX</span>
              </div>
              <div className="w-10 h-6 rounded bg-white/10 flex items-center justify-center">
                <span className="text-[10px] text-zinc-400 font-medium">PAY</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/cookies" className="text-xs text-zinc-600 hover:text-zinc-400 transition-colors">
              Cookies
            </Link>
          </div>
        </div>
